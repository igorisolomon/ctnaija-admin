...
MatCheckbox.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: MatCheckbox, selectors: [["mat-checkbox"]], viewQuery: function MatCheckbox_Query(rf, ctx) { if (rf & 1) {
        ...
        var _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵreference"](13);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵattribute"]("for", ctx.inputId);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵclassProp"]("mat-checkbox-inner-container-no-side-margin", !_r2.textContent || !_r2.textContent.trim());
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("matRippleTrigger", _r0)("matRippleDisabled", ctx._isRippleDisabled())("matRippleRadius", 20)("matRippleCentered", true)("matRippleAnimation", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpureFunction0"](18, _c1));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n    <div class=\"container-fluid\">\n\n        <div class=\"row\">\n            <div class=\"col-lg-12 col-md-12\">\n                <div class=\"card\">\n                    <div class=\"card-header card-header-danger\">\n                        <h4 class=\"card-title\">Comments</h4>\n                        <p class=\"card-category\">Reply and Delete Comments</p>\n                    </div>\n                    <div class=\"card-body\">\n                        <div class=\"tab-content\">\n                            <div class=\"tab-pane active\" id=\"profile\">\n                                <table class=\"table\">\n                                    <tbody>\n                                        <tr *ngFor=\"let comment of comments\">\n                                            <td>{{comment.name}}</td>\n                                            <td>{{comment.comment}}</td>\n                                            <td class=\"td-actions text-right\">\n                                                <!-- <button mat-raised-button type=\"button\" matTooltip=\"Reply Comment\" [matTooltipPosition]=\"'above'\" class=\"btn btn-primary btn-link btn-sm btn-just-icon\">\n                                                    <i class=\"material-icons\">question_answer</i>\n                                                </button> -->\n                                                <button mat-raised-button type=\"button\" matTooltip=\"Remove\" [matTooltipPosition]=\"'above'\" class=\"btn btn-danger btn-link btn-sm btn-just-icon\" (click)=\"onDelete(comment.id)\">\n                                                    <i class=\"material-icons\">close</i>\n                                                </button>\n                                            </td>\n                                        </tr>\n                                    </tbody>\n                                </table>\n                            </div>\n                        </div>\n                        <div class=\"reply\" *ngIf=\"postId\">\n                            <h3>Reply</h3>\n                            <form [formGroup]=\"replyForm\" (ngSubmit)=\"onReply(replyForm)\">\n                                <mat-form-field appearance=\"outline\">\n                                    <mat-label>Reply</mat-label>\n                                    <input \n                                        matInput\n                                        formControlName=\"comment\"\n                                        maxlength=\"256\">\n                                </mat-form-field>\n\t\t\t\t\t\t        <button class=\"btn btn-danger mt-4\" type='submit' [disabled]=\"!replyForm.valid\">Reply</button>\n                            </form>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n  <div class=\"container-fluid\">\n      <div class=\"row\">\n\t\t\t\t\t<div class=\"col-md-5\">\n\t\t\t\t\t\t\t<div class=\"card card-profile\">\n\t\t\t\t\t\t\t\t\t<div class=\"img-card\"><img class=\"card img\" src={{company?.logo}} /></div>\n\t\t\t\t\t\t\t\t\t<div class=\"card-body\">\n\t\t\t\t\t\t\t\t\t\t\t<h4 class=\"card-title\">{{company?.name}}</h4>\n\t\t\t\t\t\t\t\t\t\t\t<p class=\"card-description\">{{company?.email}} <br>{{company?.phone}}</p>\n\t\t\t\t\t\t\t\t\t\t\t<p class=\"card-description\">{{company?.about}}</p>\n\t\t\t\t\t\t\t\t\t\t\t<a class=\"btn btn-danger btn-round\" [routerLink]=\"['/company']\">Edit</a>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n                    </div>\n\n          <div class=\"col-md-7\">\n            <div class=\"row\">\n                <!-- <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-warning card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"material-icons\">content_copy</i>\n                            </div>\n                            <p class=\"card-category\">Views</p>\n                            <h3 class=\"card-title\">{{views?.toLocaleString()}}</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Total Number of Views</div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-success card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"material-icons\">store</i>\n                            </div>\n                            <p class=\"card-category\">Post</p>\n                            <h3 class=\"card-title\">245</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Total Number of Posts</div>\n                        </div>\n                    </div>\n                </div> -->\n                <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-blue card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"fa fa-facebook\"></i>\n                            </div>\n                            <p class=\"card-category\">Facebook</p>\n                            <h3 class=\"card-title\">{{(+company?.facebook_fans)?.toLocaleString()}}</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Facebook Fans</div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-info card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"fa fa-twitter\"></i>\n                            </div>\n                            <p class=\"card-category\">Twitter</p>\n                            <h3 class=\"card-title\">{{(+company?.twitter_fans)?.toLocaleString()}}</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Twitter Followers</div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-red card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"fa fa-youtube\"></i>\n                            </div>\n                            <p class=\"card-category\">Youtube</p>\n                            <h3 class=\"card-title\">{{(+company?.youtube_fans)?.toLocaleString()}}</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Youtube Subscriptions</div>\n                        </div>\n                    </div>\n                </div>\n                <div class=\"col-lg-6 col-md-6 col-sm-6\">\n                    <div class=\"card card-stats\">\n                        <div class=\"card-header card-header-rose card-header-icon\">\n                            <div class=\"card-icon\">\n                                <i class=\"fa fa-instagram\"></i>\n                            </div>\n                            <p class=\"card-category\">Instagram</p>\n                            <h3 class=\"card-title\">5,326</h3>\n                        </div>\n                        <div class=\"card-footer\">\n                            <div class=\"stats\">Instagram Followers</div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n          </div>\n      </div>\n  </div>\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n    <div class=\"container-fluid\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div class=\"card\">\n                    <div class=\"card-header card-header-danger\">\n                        <h4 class=\"card-title \">Posts</h4>\n                        <p class=\"card-category\"> List of post</p>\n                    </div>\n\n                    <div class=\"col-md-4 col-sm-2\">\n                        <a class=\"btn btn-danger\" [routerLink]=\"['/post']\">\n                            <i class=\"material-icons\">note_add</i>\n                            New Post\n                        </a>\n                    </div>\n                    <div class=\"card-body\">\n                        <div class=\"table-responsive\">\n                            <table class=\"table\">\n                                <thead class=\" text-primary\">\n                                    <th>\n                                        S/N\n                                    </th>\n                                    <th>\n                                        Title\n                                    </th>\n                                </thead>\n                                <tbody *ngFor=\"let post of posts?.results; let i = index\" >\n                                    <tr>\n                                        <td>\n                                            {{((page-1)*10)+i+1}}\n                                        </td>\n                                        <td>\n                                            {{post?.title}}\n                                        </td>\n                                        <td class=\"td-actions text-right\">\n                                            <button \n                                                mat-raised-button \n                                                type=\"button\" \n                                                matTooltip=\"Edit Task\" \n                                                [matTooltipPosition]=\"'above'\" \n                                                (click)=\"edit(post)\"\n                                                class=\"btn btn-primary btn-link btn-sm btn-just-icon\">\n                                                <i class=\"material-icons\">edit</i>\n                                            </button>\n                                        </td>\n                                    </tr>\n                                </tbody>\n                            </table>\n                        </div>\n                        <div class='row bottom-btn'>\n                            <div class=\"col-md-4 col-sm-2\">\n                                <button class=\"btn btn-danger\" [disabled]=\"!posts?.previous\" (click)=\"getPostList(posts.previous)\">Previous</button>\n                            </div>\n                            <div class=\"col-md-4 col-sm-2\">\n                                <button class=\"btn btn-danger\" [disabled]=\"!posts?.next\" (click)=\"getPostList(posts.next)\">Next</button>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n  </div>\n  ");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"main-content\">\n  <div class=\"container-fluid\">\n      <div class=\"row\">\n          <div class=\"col-md-8\">\n              <div class=\"card\">\n                  <div class=\"card-header card-header-danger\">\n                      <h4 class=\"card-title\">Edit Company</h4>\n                      <p class=\"card-category\">Complete your company profile</p>\n                  </div>\n                  <div class=\"card-body\">\n                      <form \n                        [formGroup]=\"companyForm\" \n                        enctype=\"multipart/form-data\"\n                        (ngSubmit)=\"updateCompanyDetais(companyForm)\">\n                          <div class=\"row\">\n                              <div class=\"col-md-5\">\n                                <mat-form-field appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Company</mat-label>\n                                    <input \n                                      matInput \n                                      formControlName=\"name\" \n                                      placeholder=\"Company Name\">\n                                  </mat-form-field>\n                              </div>\n                              <div class=\"col-md-3\">\n                                  <mat-form-field appearance=\"outline\">\n                                    <mat-label>Phone Number</mat-label>\n                                    <input \n                                      matInput \n                                      formControlName=\"phone\" \n                                      placeholder=\"Phone Number\">\n                                  </mat-form-field>\n                              </div>\n                              <div class=\"col-md-4\">\n                                  <mat-form-field appearance=\"outline\">\n                                    <mat-label>Email</mat-label>\n                                    <input \n                                      matInput \n                                      type=\"email\" \n                                      formControlName=\"email\" \n                                      placeholder=\"Email address\">\n                                  </mat-form-field>\n                              </div>\n                          </div>\n                          <div class=\"row\">\n                            <div class=\"col-md-6 mb-2\">\n                              <input \n                                type=\"file\" \n                                name=\"myImage\" \n                                accept=\"image/jpeg,image/png\"\n                                (change)=\"onFileChange($event)\">\n                            </div>\n                          </div>\n                          <div class=\"row\">\n                              <div class=\"col-md-8\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Facebook Link</mat-label>\n                                  <input \n                                    matInput \n                                    formControlName=\"facebook\" \n                                    placeholder=\"Facebook Link\">\n                                </mat-form-field>\n                              </div>\n                              <div class=\"col-md-4\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Facebook Fans</mat-label>\n                                  <input \n                                    matInput type=\"number\" \n                                    formControlName=\"facebook_fans\" \n                                    placeholder=\"Number of Facebook Fans\">\n                                </mat-form-field>\n                              </div>\n                          </div>\n                          <div class=\"row\">\n                              <div class=\"col-md-8\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Twitter Link</mat-label>\n                                  <input \n                                    matInput \n                                    formControlName=\"twitter\" \n                                    placeholder=\"Twitter Link\">\n                                </mat-form-field>\n                              </div>\n                              <div class=\"col-md-4\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Twitter Fans</mat-label>\n                                  <input \n                                    matInput type=\"number\" \n                                    formControlName=\"twitter_fans\" \n                                    placeholder=\"Number of Twitter Fans\">\n                                </mat-form-field>\n                              </div>\n                          </div>\n                          <div class=\"row\">\n                              <div class=\"col-md-8\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Youtube Link</mat-label>\n                                  <input \n                                    matInput \n                                    formControlName=\"youtube\" \n                                    placeholder=\"Youtube Link\">\n                                </mat-form-field>\n                              </div>\n                              <div class=\"col-md-4\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Youtube Fans</mat-label>\n                                  <input \n                                    matInput type=\"number\" \n                                    formControlName=\"youtube_fans\" \n                                    placeholder=\"Number of Youtube Fans\">\n                                </mat-form-field>\n                              </div>\n                          </div>\n                          <!-- <div class=\"row\">\n                              <div class=\"col-md-8\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Instagram Link</mat-label>\n                                  <input matInput formControlName=\"instagram\" placeholder=\"Instagram Link\">\n                                </mat-form-field>\n                              </div>\n                              <div class=\"col-md-4\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>Instagram Followers</mat-label>\n                                  <input matInput type=\"number\" formControlName=\"instagram_fans\" placeholder=\"Number of Instagram Followers\">\n                                </mat-form-field>\n                              </div>\n                          </div> -->\n                          <div class=\"row\">\n                              <div class=\"col-md-12\">\n                                <mat-form-field class=\"example-full-width\" appearance=\"outline\">\n\t\t\t\t\t\t\t\t                  <mat-label>About Company</mat-label>\n                                   <textarea rows=\"5\" matInput placeholder=\"Tell us about your company.\" formControlName=\"about\"></textarea>\n                                 </mat-form-field>\n                              </div>\n                          </div>\n                          <button mat-raised-button type=\"submit\" class=\"btn btn-danger pull-right\">Update Profile</button>\n                          <div class=\"clearfix\"></div>\n                      </form>\n                  </div>\n              </div>\n          </div>\n      </div>\n  </div>\n</div>\n");
...
/* harmony import */ var app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/shared/services/blog.service */ "./src/app/shared/services/blog.service.ts");
...
var CommentsComponent = /** @class */ (function () {
    function CommentsComponent(blogService, fb) {
        this.blogService = blogService;
        this.fb = fb;
        this.replyForm = this.fb.group({
            comment: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(256)]),
        });
    }
    CommentsComponent.prototype.ngOnInit = function () {
        this.getComment();
    };
    CommentsComponent.prototype.getComment = function () {
        var _this = this;
        this.blogService.fetchComments(this.postId).subscribe(function (response) { return _this.comments = response; });
    };
    CommentsComponent.prototype.onDelete = function (id) {
        var _this = this;
        this.blogService.deleteComment(id).subscribe(function (response) {
            _this.getComment();
        });
    };
    CommentsComponent.prototype.onReply = function (replyForm) {
        var _this = this;
        var payload = {
            name: "CTNaija",
        ...
        this.blogService.createComment(payload).subscribe(function (response) {
            // update comment
            _this.getComment();
            // clear form
    ...
    CommentsComponent.ctorParameters = function () { return [
        { type: app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_1__["BlogService"] },
    ...
    CommentsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_1__["BlogService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".img-card{\n    margin-top: -50px;\n}\n\nimg.img{\n    width: 150px;\n    height: auto;\n    border-radius: 10px;\n    background-color: white;\n    padding: 20px;\n    margin: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.fetchCompanyDetail = function () {
        var _this = this;
        this.blogService.fetchCompany().subscribe(function (response) {
...
/* harmony import */ var app_posts_posts_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! app/posts/posts.component */ "./src/app/posts/posts.component.ts");
/* harmony import */ var app_comments_comments_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! app/comments/comments.component */ "./src/app/comments/comments.component.ts");
/* harmony import */ var app_posts_post_post_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! app/posts/post/post.component */ "./src/app/posts/post/post.component.ts");
    ...
    AdminLayoutModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                app_posts_posts_component__WEBPACK_IMPORTED_MODULE_15__["PostsComponent"],
                app_comments_comments_component__WEBPACK_IMPORTED_MODULE_16__["CommentsComponent"],
                app_posts_post_post_component__WEBPACK_IMPORTED_MODULE_17__["PostComponent"]
            ],
            providers: [
                { provide: _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MAT_FORM_FIELD_DEFAULT_OPTIONS"], useValue: { floatLabel: 'always' } }
            ]
        })
    ], AdminLayoutModule);
...
/* harmony import */ var app_posts_posts_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/posts/posts.component */ "./src/app/posts/posts.component.ts");
/* harmony import */ var app_comments_comments_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/comments/comments.component */ "./src/app/comments/comments.component.ts");
/* harmony import */ var app_posts_post_post_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/posts/post/post.component */ "./src/app/posts/post/post.component.ts");
/* harmony import */ var app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/shared/guards/auth.guard */ "./src/app/shared/guards/auth.guard.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
var AdminLayoutRoutes = [
    {
        ...
        canActivate: [app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    },
    {
        path: 'company',
    ...
    {
        path: 'posts',
        component: app_posts_posts_component__WEBPACK_IMPORTED_MODULE_3__["PostsComponent"],
        canActivate: [app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    },
    {
        path: 'comments',
        component: app_comments_comments_component__WEBPACK_IMPORTED_MODULE_4__["CommentsComponent"],
        canActivate: [app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    },
    {
        path: 'post',
        component: app_posts_post_post_component__WEBPACK_IMPORTED_MODULE_5__["PostComponent"],
        canActivate: [app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* .new-post{\n    width: 100%;\n    height: 100vh;\n    background-color: #ffffff;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.cont{\n    width: 80%;\n}\n\n.post-file{\n    width: 40%;\n    border: 1px solid rgb(185, 185, 185);\n    border-radius: 5px;\n} */\n\n.post-nav{\n    margin-bottom: 20px;\n}\n\n.post-nav button{\n    background-color: #d9534f;\n    float: right;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/shared/services/blog.service */ "./src/app/shared/services/blog.service.ts");
/* harmony import */ var app_shared_services_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! app/shared/services/data.service */ "./src/app/shared/services/data.service.ts");
...
/* harmony import */ var quill_image_resize_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! quill-image-resize-module */ "./node_modules/quill-image-resize-module/image-resize.min.js");
/* harmony import */ var quill_image_resize_module__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(quill_image_resize_module__WEBPACK_IMPORTED_MODULE_6__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Quill = quill__WEBPACK_IMPORTED_MODULE_5__;
Quill.register('modules/imageResize', quill_image_resize_module__WEBPACK_IMPORTED_MODULE_6___default.a);
var PostComponent = /** @class */ (function () {
    function PostComponent(fb, router, blogService, dataService) {
        this.fb = fb;
        this.router = router;
        this.blogService = blogService;
    ...
    PostComponent.prototype.ngOnInit = function () {
        var _this = this;
        var _a;
        this.blogService.fetchCat().subscribe(function (res) { return _this.categories = res; });
        var updatePost = this.dataService.post.value;
        // clear post
        this.dataService.update(null);
        this.postId = (_a = updatePost) === null || _a === void 0 ? void 0 : _a.id;
        if (updatePost) {
            this.editorForm = this.fb.group({
                id: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](updatePost.id),
                title: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](updatePost.title),
                media: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](null),
                body: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](updatePost.body),
                body_html: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](updatePost.body_html ? updatePost.body_html : updatePost.body),
                categorys: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](updatePost.categorys)
            });
        }
        else {
            this.editorForm = this.fb.group({
                ...
                body_html: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](""),
                categorys: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]()
            });
        }
    };
    PostComponent.prototype.onFileChange = function (event) {
        if (event.target.files.length > 0) {
            var file = event.target.files[0];
            this.editorForm.get('media').setValue(file);
        }
    };
    PostComponent.prototype.onBodyChange = function (event) {
        this.body = event.text;
        this.editorForm.value.body_html = event.html;
    };
    PostComponent.prototype.onCategoryChange = function (event) {
        this.editorForm.value.categorys = event.value.map(function (x) { return +x; });
    };
    PostComponent.prototype.onSubmit = function (editorForm) {
        var _this = this;
        ...
        var payload = editorForm.value;
        payload.body = this.body;
        delete payload.media;
        this.blogService.createPost(payload).subscribe(function (response) {
            _this.blogService.editPost(response.id, formData).subscribe(function (response) {
                _this.router.navigateByUrl('/posts');
            });
        });
    };
    PostComponent.prototype.onEdit = function (editorForm) {
        var _this = this;
        var payload = editorForm.value;
        var id = payload.id;
        var formData = new FormData();
        ...
        if (this.editorForm.value.media) {
            this.blogService.editPost(id, formData).subscribe(function (response) {
                console.log(response);
            });
        }
        ...
        this.blogService.editPost(id, payload).subscribe(function (response) {
            _this.router.navigateByUrl('/posts');
        });
    };
    PostComponent.prototype.onDelete = function (id) {
        var _this = this;
        this.blogService.deletePost(id).subscribe(function (response) {
            _this.router.navigateByUrl('/posts');
        });
    };
    PostComponent.ctorParameters = function () { return [
        ...
        { type: app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"] },
        { type: app_shared_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"] }
    ]; };
    PostComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-post',
            template: __importDefault(__webpack_require__(/*! raw-loader!./post.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/posts/post/post.component.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./post.component.css */ "./src/app/posts/post/post.component.css")).default]
        }),
        __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"],
            app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_2__["BlogService"],
            app_shared_services_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]])
    ], PostComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".flexing{\n    display: -webkit-box;\n    display: flex;\n}\n\n.bottom-btn{\n    color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(router, blogService, dataService) {
        this.router = router;
        this.blogService = blogService;
        this.dataService = dataService;
        this.page = 1;
    ...
    PostsComponent.prototype.getPostList = function (link) {
        var _this = this;
        var _a;
        var page = 1;
        if (link) {
            var pageArr = link.split('=');
            page = pageArr.length > 1 ? parseInt(pageArr[((_a = pageArr) === null || _a === void 0 ? void 0 : _a.length) - 1]) : 1;
            this.page = page;
        }
        this.blogService.fetchPost(page).subscribe(function (response) {
            _this.posts = response;
        });
    };
    PostsComponent.prototype.edit = function (post) {
    ...
    PostsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            app_shared_services_blog_service__WEBPACK_IMPORTED_MODULE_1__["BlogService"],
            app_shared_services_data_service__WEBPACK_IMPORTED_MODULE_2__["DataService"]])
    ], PostsComponent);
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(blogService, fb, router) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        this.blogService = blogService;
        this.fb = fb;
        this.router = router;
        this.companyForm = this.fb.group({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_a = this.company) === null || _a === void 0 ? void 0 : _a.name),
            phone: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_b = this.company) === null || _b === void 0 ? void 0 : _b.phone),
            email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_c = this.company) === null || _c === void 0 ? void 0 : _c.email),
            about: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_d = this.company) === null || _d === void 0 ? void 0 : _d.about),
            logo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"](null),
            facebook: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_e = this.company) === null || _e === void 0 ? void 0 : _e.facebook),
            facebook_fans: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_f = this.company) === null || _f === void 0 ? void 0 : _f.facebook_fans),
            twitter: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_g = this.company) === null || _g === void 0 ? void 0 : _g.twitter),
            twitter_fans: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_h = this.company) === null || _h === void 0 ? void 0 : _h.twitter_fans),
            youtube: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_j = this.company) === null || _j === void 0 ? void 0 : _j.youtube),
            youtube_fans: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]((_k = this.company) === null || _k === void 0 ? void 0 : _k.youtube_fans),
        });
    }
    ...
    UserProfileComponent.prototype.fetchCompanyDetail = function () {
        var _this = this;
        this.blogService.fetchCompany().subscribe(function (response) {
            var _a;
            _this.companyForm.patchValue({
                name: (_a = response) === null || _a === void 0 ? void 0 : _a.name,
    ...
    UserProfileComponent.prototype.updateCompanyDetais = function (companyForm) {
        var _this = this;
        var formData = new FormData();
        ...
        this.blogService.editCompany(formData).subscribe(function (response) {
